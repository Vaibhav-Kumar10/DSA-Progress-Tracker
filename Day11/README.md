...
## <strong>📖 Day 11 - 11/05/2025 – Medium Array Problems</strong>

This folder contains my C++ implementations of problems practiced as part of Striver A2Z DSA Sheet - Day 11 (Arrays – Medium Level).

| 🧠 Problem                        | 🚦 Difficulty | ✅ Status | 🔗 Practice Link                                                     | 💻 My Solution                        |
| --------------------------------- | ------------- | --------- | -------------------------------------------------------------------- | ------------------------------------- |
| Sort an Array of 0's, 1's and 2's | Medium        | ✅ Solved | [Leetcode – Sort Colors](https://leetcode.com/problems/sort-colors/) | [📄 sortColors.cpp](./sortColors.cpp) |
