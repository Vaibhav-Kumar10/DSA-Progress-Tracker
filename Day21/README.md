...
## <strong>📖 Day 21 - 21/05/2025 – Medium Array Problems</strong>

This folder contains my C++ implementations of problems practiced as part of Striver A2Z DSA Sheet - Day 21 (Rotate Matrix by 90 Degrees).

| 🧠 Problem                  | 🚦 Difficulty | ✅ Status | 🔗 Practice Link                                                       | 💻 My Solution                                |
| --------------------------- | ------------- | --------- | ---------------------------------------------------------------------- | --------------------------------------------- |
| Rotate Matrix by 90 Degrees | Medium        | ✅ Solved | [Leetcode – Rotate Image](https://leetcode.com/problems/rotate-image/) | [📄 rotateMatrix90.cpp](./rotateMatrix90.cpp) |
