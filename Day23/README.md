...
## <strong>📖 Day 23 - 23/05/2025 – Medium Matrix Problems</strong>

This folder contains my C++ implementations of problems practiced as part of Striver A2Z DSA Sheet - Day 23.

| 🧠 Problem                         | 🚦 Difficulty | ✅ Status | 🔗 Practice Link                                                                         | 💻 My Solution                                        |
| ---------------------------------- | ------------- | --------- | ---------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| Count Subarrays with Given Sum (K) | Easy          | ✅ Solved | [Leetcode – Subarray Sum Equals K](https://leetcode.com/problems/subarray-sum-equals-k/) | [📄 countSubarraysSumK.cpp](./countSubarraysSumK.cpp) |
