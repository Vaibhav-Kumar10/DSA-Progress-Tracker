...
## <strong>📖 Day 29 - 29/05/2025 – Mixed Array Problems</strong>
...
| -------------------------------- | ------------- | --------- | ----------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------- |
| Count Subarrays with Given XOR K | Hard          | ✅ Solved | [Coding Ninjas – Subarrays with XOR K](https://www.codingninjas.com/studio/problems/subarrays-with-xor-k_6826258) | [📄 countSubarraysWithXOR.cpp](./countSubarraysWithXOR.cpp) |
