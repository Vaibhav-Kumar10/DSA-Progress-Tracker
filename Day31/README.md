...
## <strong>📖 Day 31 - 31/05/2025 – Mixed Array Problems</strong>

This folder contains my C++ implementation of the in-place merging of two sorted arrays without using extra space, as part of Striver's A2Z DSA Sheet.

| 🧠 Problem                            | 🚦 Difficulty | ✅ Status | 🔗 Practice Link                                                                   | 💻 My Solution                                                |
| ------------------------------------- | ------------- | --------- | ---------------------------------------------------------------------------------- | ------------------------------------------------------------- |
| Merge Two Sorted Arrays Without Space | Medium        | ✅ Solved | [Leetcode – Merge Sorted Array](https://leetcode.com/problems/merge-sorted-array/) | [📄 mergeWithoutExtraSpace.cpp](./mergeWithoutExtraSpace.cpp) |
