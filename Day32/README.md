...
## <strong>📖 Day 32 - 01/06/2025 – Mixed Array Problems</strong>

This folder contains my C++ implementations of advanced and edge-case array problems from Striver's A2Z DSA Sheet.

| 🧠 Problem                            | 🚦 Difficulty | ✅ Status | 🔗 Practice Link                                                                                         | 💻 My Solution                                            |
| ------------------------------------- | ------------- | --------- | -------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- |
| Find the Repeating and Missing Number | Hard          | ✅ Solved | [GFG – Find Missing And Repeating](https://www.geeksforgeeks.org/find-a-repeating-and-a-missing-number/) | [📄 findMissingRepeating.cpp](./findMissingRepeating.cpp) |
